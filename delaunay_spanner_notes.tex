...
\begin{figure}
  \includegraphics[scale=1.2]{figures/height_width.pdf}
...
\begin{figure}
  \includegraphics[scale=3.0]{figures/height_width2.pdf}
  \caption{An example showing $T$ where $h > w/4$.}
\end{figure}
...
% diagram showing conditions of lemma
